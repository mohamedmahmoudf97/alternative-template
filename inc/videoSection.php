	...
	<!--	this section for video	-->
	<!--	Start section for video	-->
	<section class="ftco-section ftco-no-pt ftc-no-pb">
		<div class="container">
			<div class="row ">
				...
				-->
				<!--	Start Video 	-->
				<div class="col-md-6 order-md-last wrap-about py-5 wrap-about bg-light align-content-center d-flex">
					<video class="d-block container-fluid p-0" autoplay loop>
